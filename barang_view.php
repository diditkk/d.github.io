...
<!-- content -->
 <div class="row">
    ...
    <div class="mx-5">
      <h1 class="font-weight-bold mt-1"><i class="fas fa-archive"></i> Data Barang</h1>
      <a href="barang_tambah.php"><button type="button" class="btn btn-info text-decoration-none float-xl-right mb-3 mr-4"> + Tambah Data</button></a>
      <br>
...
<tr>
 <td><?= $i; ?></td>
  <td><a href="barang_ubah.php?id_barang=<?= $row["id_barang"];?> "><button type="button" class="btn btn-primary btn-sm">Ubah</button></a> 
    <a href="barang_hapus.php?id_barang=<?= $row["id_barang"]; ?>" onclick = "return confirm('Anda yakin untuk menghapus data?')"><button type="button" class="btn btn-danger btn-sm">Hapus</button></a>
  </td>
